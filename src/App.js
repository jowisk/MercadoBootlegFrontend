...
function App() {
  ...
  const discover = [
    {
      title: "calzado",
      desc: "¡renova tu look!",
      img: "http://localhost:3000/discover1.jpg",
    },
    {
      title: "moda de invierno",
      desc: "tu look ideal",
      img: "http://localhost:3000/discover2.jpg",
    },
  ];
  ...
  const footerItems = [
    {
      ...
      how: "Cómo pagar con Mercado Pago",
    },
    {
      icon: "box",
      title: "Envío gratis desde $ 2.000",
      desc: "Elige Mercado Envíos en tus compras y disfruta de envíos gratis en miles de productos nuevos.",
      how: "Cómo recibo compras con Mercado Envíos",
    },
    {
      icon: "shield",
      title: "Seguridad, de principio a fin",
      desc: "¿No te gusta? ¡Devuélvelo! En Mercado Libre, no hay nada que no puedas hacer, porque estás siempre protegido.",
      how: "Cómo te protegemos",
    },
  ];
  ...
  const lists = [
    ...
    {
      title: "Relacionado con tus visitas en",
      products: [
        {
          id: 0,
          name: "Monitor 144Hz",
          url: "http://localhost:3000/img3.jpg",
          price: "300",
          currency: "U$S",
          discount: "0",
        },
    ...
    },
    {
      ...
      products: [
        ...
        },
        {
          id: 1,
          name: "Vasito",
          url: "http://localhost:3000/img6.jpg",
          price: "5",
          currency: "$",
          discount: "1",
        },
  ...
  if (!menuState) {
    return (
      <div className="overflow-x-hidden">
        <Header handleMenuState={handleMenuState} menuState={menuState} />

        <Nav name={"Joe"} address={"Paraguay 2141"} />
        ...
        {lists.map((list) => (
          <ProductList title={list.title} products={list.products} />
        ))}
